...
if (isset($_SESSION['uID'])) {
    if (isset($_SESSION['uID'])) {
        ...
        $redirectUrls->setReturnUrl('http://localhost/modern_web_project/public_html/vendor/pay.php?success=true')
                ->setCancelUrl('http://localhost/modern_web_project/public_html/vendor/pay.php?success=false');
        $payment = new Payment();
