        ...
        <div class="container-fluid mt-5 px-5">
            <div class="login_container center d-block mx-auto w-50">
                ...
                <p class="text-center mt-4">
                    <a style="background-color: #3E4551; color: white; cursor: pointer;" class="btn my-2 px-5" id="collapse_btn1">Personal Information</a>
                    <button style="background-color: #cbccd4; color: white;" class="btn px-5" id="collapse_btn2" type="button">Change Password</button>
                </p>
                <div style="display: block;" id="update_profile_form">
                    <form class="d-block mx-auto pt-2" name="update_profile_form" method="post" onsubmit="return update_profile_form_validate()" action="<?php echo filter_input(INPUT_SERVER, 'PHP_SELF', FILTER_SANITIZE_URL) ?>">
                        ...
                        <button type="submit" class="btn btn-success btn-block mb-2" name="update_profile_submit">SAVE</button>
                    </form>
                </div>

                <div style="display: none;" id="change_pwd_form">
                    <form class="d-block mx-auto pt-2" name="change_pwd_form" method="post" onsubmit="return change_pwd_validate()" action="<?php echo filter_input(INPUT_SERVER, 'PHP_SELF', FILTER_SANITIZE_URL) ?>">
                        <!--password-->
                        <div class="input-group mb-3 mr-sm-2">
                            <div class="input-group-prepend">
                                <div class="input-group-text">
                        ...
                        <button type="submit" class="btn btn-success btn-block mb-2" name="change_pwd_submit">UPDATE</button>
                    </form>
                </div>
            </div>
        </div>
